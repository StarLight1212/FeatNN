...
def get_pdbid_to_uniprot():
	pdbid_to_uniprot = {}
	with open('./fileprocessing/output/out2_pdbbind_data_datafile.tsv') as f:
...
if __name__ == '__main__':
	...
	fw1 = open('./fileprocessing/output/out6.1_query_pdb.fasta', 'w')
	fw2 = open('./fileprocessing/output/out6.1_target_uniprot_pdb.fasta', 'w')
	...
	# PDBbind-v2020
	with open('./fileprocessing/output/out5_pocket_dict', 'rb') as f:
		interaction_dict = pickle.load(f)
	fw1 = open('./fileprocessing/output/out6.2_query_pdbbind.fasta', 'w')
	fw2 = open('./fileprocessing/output/out6.2_target_uniprot_pdbbind.fasta', 'w')
